...
def run_test(test_name, args): 
    ...
    try:
        ...
        print("Program exited with code:", result.returncode)
        
    except FileNotFoundError:
        print("Error: Compiled Haskell binary 'compiler' not found. Run 'ghc -o compiler Main.hs' first.")
    print("-------------------------------\n")
